...
void CFGFilterLAVVideo::Settings::LoadSettings()
{
    ...
    bHWFormats[HWCodec_MPEG2DVD_Deprecated] = false; //pApp->GetProfileInt(IDS_R_INTERNAL_LAVVIDEO_HWACCEL, _T("dvd"), bHWFormats[HWCodec_MPEG2DVD_Deprecated]);
...
void CFGFilterLAVVideo::Settings::SaveSettings()
{
    ...
    pApp->WriteProfileInt(IDS_R_INTERNAL_LAVVIDEO_HWACCEL, _T("dvd"), bHWFormats[HWCodec_MPEG2DVD_Deprecated]);
